...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--danet_cfg_file', type=str, default='./configs/danet_default.yaml', help='config file path for DaNet.')
        train.add_argument('--train_data', type=str, default='h36m_dp', choices=['h36m_dp', 'h36m_coco_itw'], help='Training datasets selection.')
        ...
        train.add_argument('--vis_interval', default=1000, type=int, help='Visualize training info every N iterations')
        train.add_argument('--pretr_step', default=5000, type=int, help='Step number for pretraining uv estimator.')
