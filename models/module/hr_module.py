# code brought in part from https://github.com/leoxiaobin/deep-high-resolution-net.pytorch/blob/master/lib/models/pose_hrnet.py
...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, part_out_dim=25):
        ...
        self.final_feat_dim = pre_stage_channels[0]
